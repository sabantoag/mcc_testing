...
MANUAL_ANALOG_INPUT_CHANNEL = 1  # Analog input channel used to read manual mode voltage.
...
def test_manual_mode(daq_device: DaqDeviceInfo):
    try:
        ...
        measured_voltage = measure_voltage(daq_device, MANUAL_ANALOG_INPUT_CHANNEL)
